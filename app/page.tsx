    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[56px] items-center max-w-[1080px] mx-auto py-[100px] px-6" id="company">
        <div>
          ...
          <div className="flex flex-col gap-3 mt-6 reveal">
            ...
            <div className="flex items-center gap-2.5 text-[14px] text-[#5a5a7a]">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2673B5" strokeWidth="2" className="shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              +91-124-4567890
            </div>
            <div className="flex items-center gap-2.5 text-[14px] text-[#5a5a7a]">
      ...
      <section id="contact" className="py-[100px] px-6 max-w-[1080px] mx-auto text-center">
        ...
        <div className="mt-6 text-[14px] text-[#9090a8] reveal">
          Or reach us directly: <a href="mailto:contact@infrax.ai" className="text-[#5a5a7a] hover:text-[#1a1a2e]">contact@infrax.ai</a> · <a href="tel:+911244567890" className="text-[#5a5a7a]">+91-124-4567890</a>
        </div>
      </section>

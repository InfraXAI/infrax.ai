...
export const metadata: Metadata = {
  ...
  description: 'Buildings that think. HVAC optimization, energy analytics, predictive maintenance — all automated.',
};
  ...
  return (
    <>
        ...
        <div className="max-w-[1080px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] rounded-2xl overflow-hidden bg-[#e8e8ee]">
            {[
              ...
              { title: 'Legacy Systems Just Log Data', desc: "Your existing systems collect data. But they don't optimize, predict, or automate. They are glorified loggers." },
            ].map((item) => (
      ...
      <section className="py-[100px] px-6">
        <div className="max-w-[1080px] mx-auto">
          <SectionHeader label="The InfraX Solution" title="Turn Your Building Into an AI Brain" centered />
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-[15px] text-[#5a5a7a] leading-[1.7] mb-6">
                InfraX AI connects with your existing systems and transforms them into an intelligent, autonomous operation. No rip and replace. Just add intelligence.
              </p>
              <div className="space-y-4">
                {[
                  { title: 'Predictive HVAC', desc: 'AI learns usage patterns and optimizes cooling/heating. 30-40% energy savings typical.' },
                  { title: 'Smart Lighting', desc: 'Daylight harvesting and automated scheduling. No more lights in empty rooms.' },
                  { title: 'Predictive Maintenance', desc: 'Detect equipment anomalies before they fail. Schedule maintenance during off-hours.' },
                  { title: 'Works With Any System', desc: 'Integrates with Honeywell, Johnson Controls, Siemens, and any existing hardware.' },
                ].map((item) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard icon={<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" strokeLinecap="round" strokeLinejoin="round"/></svg>} title="Security & Safety" description="Camera-based anomaly detection, unauthorized access alerts, and fire safety compliance." />
      ...
      <section className="py-[100px] px-6">
        <div className="max-w-[1080px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] rounded-2xl overflow-hidden bg-[#e8e8ee]">
            {[
              { title: 'Commercial Offices', desc: 'Optimize energy for floor-by-floor usage. Reduce HVAC waste. Automate lighting based on daylight schedules.' },
              { title: 'Shopping Malls', desc: 'Zone-based HVAC control. Predictive maintenance for escalators and elevators. Energy optimization.' },
